...
<body class="bg-[#F8F7F3] text-[#3C4043]">
  ...
  <main class="px-4 md:px-10 py-28">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
      ...
      <div class="flex flex-col items-center justify-center space-y-6">
        <div class="relative ">
          <img src="img/Cmp2.png" alt="Proto Lite Purple" class="mx-auto w-70 aspect-square">
          <div class="flex justify-center mt-4 space-x-2">
            <img src="img/Cmp2.png" alt="Proto Lite Purple" class="w-16 h-16 object-cover rounded-lg shadow-md">
            <img src="img/Cmp2.png" alt="Proto Lite Purple" class="w-16 h-16 object-cover rounded-lg shadow-md">
          </div>
          <button class="absolute left-0 top-1/2 transform -translate-y-1/2" onclick="scrollLeft('productImages')" aria-label="Scroll Left">
        ...
        <button class="absolute right-0 top-1/2 transform -translate-y-1/2" onclick="scrollRight('productImages')" aria-label="Scroll Right">
            <svg class="w-6 h-6 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="flex flex-col items-center md:items-start space-y-6">
        <div class="space-y-2 text-center md:text-left">
          ...
          <p>About</p>
          <p class="text-sm">Following the footsteps of the PROTO 1 article, Compass® RESEARCH & DESTROY presents a basic variation of its popular predecessor titled PROTO LITE. Signature R&D elements are simplified for a more casual wear, while the four bold colours and metallic detail, add a punchy statement to your every look.</p>
