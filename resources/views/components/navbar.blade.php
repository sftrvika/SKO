    ...
    <div class="px-4 mx-auto items-center flex justify-between relative">
        ...
        <div id="nav-menu"
            ...
            <ul id="navbar-nav" class="block lg:flex">
                <li class="group"><a class="mx-8 py-2 lg:py-0 lg:mx-14 after:border-b-[1px] after:{{ $textColor ?? null == 'text-white' ? 'border-white' : 'border-[#3c4043]' }}" href="/">Home</a></li>
                <li class="group"><a class="mx-8 py-2 lg:py-0 lg:mx-14 after:border-b-[1px] after:{{ $textColor ?? null == 'text-white' ? 'border-white' : 'border-[#3c4043]' }}" href="shop">Shop</a></li>
                <li class="group"><a class="mx-8 py-2 lg:py-0 lg:mx-14 after:border-b-[1px] after:{{ $textColor ?? null == 'text-white' ? 'border-white' : 'border-[#3c4043]' }}" href="ourstory">Our Story</a></li>
                <li class="group"><a class="mx-8 py-2 lg:py-0 lg:mx-14 after:border-b-[1px] after:{{ $textColor ?? null == 'text-white' ? 'border-white' : 'border-[#3c4043]' }}" href="blog">Blog</a></li>
            </ul>
        </div>
        ...
        <div class="relative inline-block text-left">
            ...
            <div id="profileDropdown" class="dropdown-content hidden absolute mt-5 w-80 max-w-40 rounded-md shadow-lg bg-white">
                ...
                <div class="mt-2 py-3 first:pt-3 last:pb-4">
                    <a class="py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-black hover:text-white focus:outline-none focus:bg-black mb-1" href="profile" style="display: flex;column-gap: 7px">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                            <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z"/>
                          </svg>
                        <p class="transition-colors duration-300">Profile</p>
                    </a>
                    <a class="flex items-center gap-32 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-black hover:text-white focus:outline-none focus:bg-black mb-1" href="cart" style="display: flex;column-gap: 7px">
                    ...
                    <a class="flex items-center gap-x-32 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-black hover:text-white focus:outline-none focus:bg-black" href="login" style="display: flex;column-gap: 7px">
